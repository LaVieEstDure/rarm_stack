...
_colcon_prefix_sh_COLCON_CURRENT_PREFIX="/home/r.mishra/projects/rarm_stack/ros_ws/src/*"
...
if [ -n "$COLCON_PYTHON_EXECUTABLE" ]; then
  ...
  _colcon_python_executable="/home/r.mishra/projects/rarm_stack/.pixi/envs/default/bin/python3.12"
